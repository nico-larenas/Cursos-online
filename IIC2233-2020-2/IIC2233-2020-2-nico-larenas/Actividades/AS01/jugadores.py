...
class Buscador(Jugador):
    ...
    def competir(self):
        enfrentar = (self.velocidad * p.PONDERADOR_VELOCIDAD_BUSCADOR)+(self.equilibrio * p.PONDERADOR_EQUILIBRIO_BUSCADOR)-(self.nerviosismo * p.PONDERADOR_NERVIOSISMO_BUSCADOR)
        return enfrentar
...
class Golpeador(Jugador):
    ...
    def competir(self):
        enfrentar = (self.velocidad * p.PONDERADOR_VELOCIDAD_GOLPEADOR)+(self.equilibrio * p.PONDERADOR_EQUILIBRIO_GOLPEADOR)-(self.nerviosismo * p.PONDERADOR_NERVIOSISMO_GOLPEADOR)
        return enfrentar
...
class Cazador(Jugador):
    ...
    def competir(self):
        enfrentar = (self.velocidad * p.PONDERADOR_VELOCIDAD_CAZADOR)+(self.equilibrio * p.PONDERADOR_EQUILIBRIO_CAZADOR)-(self.nerviosismo * p.PONDERADOR_NERVIOSISMO_CAZADOR)
        return enfrentar
