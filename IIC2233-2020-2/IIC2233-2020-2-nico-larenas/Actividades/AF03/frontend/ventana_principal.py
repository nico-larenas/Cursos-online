...
class VentanaPrincipal(QMainWindow):
    ...
    def crear_botones(self):
        ...
        self.boton1 = QPushButton('&Tarea1', self)
        self.boton1.resize(self.boton1.sizeHint())
        self.boton1.clicked.connect(self.boton_tarea_clickeado)

        self.boton2 = QPushButton('&Tarea2', self)
        self.boton2.resize(self.boton2.sizeHint())
        self.boton2.clicked.connect(self.boton_tarea_clickeado)
